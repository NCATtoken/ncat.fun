(function(a){a.fn.ddzSlider=function(l){if(this.length>1){this.each(function(){a(this).ddzSlider(l);});return this;}var d={animSpeed:250,speed:5,auto:true,easing:"swing",next:false,prev:false,prev:false,transition:"slide",pause:false,bullets:false,selector:"li",callback:function(){}};
var l=a.extend({},d,l);var k=this;k.$views=a(k.find(l.selector)).addClass("sliderView");k.$nav=a(k.find(".ddzSliderNav"));k.navItems=[];k.viewWidth=k.width();
k.animTimer=l.animSpeed;k.timerSpeed=l.speed*1000;k.easing=l.easing;k.transition=l.transition;k.current=k.$views[0];k.addClass("ddzSlider");for(var f=0;
f<k.$views.length;f++){var g=a(k.$views[f]);$bullet=a("<span></span>");k.$views[f]=g;g.add($bullet).data("idx",f);k.$nav.append($bullet);k.navItems[f]=$bullet;
